package com.stpl.trainee.aman.miniproject1.employee.bean;
...
public class AcademicDetailsBean {
	...
	public int getEmpPassYear() {
		return empPassYear;
	}

	public void setEmpPassYear(int empPassYear) {
		this.empPassYear = empPassYear;
	}
